...
public:
	...
	**	\note Callbacks have to be declared using an uint8_t as parameter (callback triggering pin is passed to the function)
	**	\return nothing
	**/
	...
	**	\return nothing
	**/
	void init(uint8_t pin, void (*cbckON)(uint8_t), void (*cbckOFF)(uint8_t)=NULL);
